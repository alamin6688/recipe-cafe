...
const Sidebar = ({ selectedRecipes }) => {
    ...
    return (
        <>
            <div className='w-full md:w-1/3 border rounded-xl h-max'>
                <div className="text-center px-14 pt-5 mb-3">
                    <h1 className="font-bold mb-2 text-lg md:text-xl">Want to cook: {selectedRecipes.length - hiddenRows.length}</h1>
                    <hr />
                </div>
                ...
                <div className="text-center px-14 pt-5 mb-3">
                    <h1 className="font-bold mb-2 text-lg md:text-xl">Currently Cooking: {currentlyCooking.length}</h1>
                    <hr />
                </div>
